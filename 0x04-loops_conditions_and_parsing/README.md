...
This project's aim is to learn about loops (`while`, `until` and `for`), condition statements (`if`, `else`, `elif` and `case`), shebangs and how to create SSH keys with **Bash**.
...
| `10-fizzbuzz` | Displays the `fizzbuzz` sequence for numbers from 1 to 100 |
